class Game {
  ...
  start() {
    ...
    car1.addAnimation("crash",car1Crash)
    ...
    car2.addAnimation("crash",car2Crash)
    car2.scale = 0.07;
  ...
  handleObstacleCollision(index) {
    if (cars[index - 1].overlap(obstacles)) {
      ...
      if (player.life > 0) {
        ...
        cars[index-1].changeAnimation("crash")
